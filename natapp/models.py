...
class IDC_IP_LIST(models.Model):
    ...
    POOL1 = models.CharField(max_length=500, db_index=True)
    POOL2 = models.CharField(max_length=500, db_index=True)
    POOL3 = models.CharField(max_length=500, db_index=True)
